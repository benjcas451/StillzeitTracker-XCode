...
enum Mh {
  ...
  /// Beidseitig-Button: neutrales Grau, im Dark nicht heller als die Pastelle.
  static let beidseitigFlaeche = dyn(0xDFE4E1, 0x3A403C)
  static let beidseitigText = dyn(0x2E332F, 0xECEFED)
}
...
// MARK: - Eintragsarten-Farben (Chip-Muster des Guides)

extension Seite {
  /// Kräftige Fläche (300) für die Schnell-Eingabe-Buttons.
  var buttonFlaeche: Color {
    switch self {
    case .links: Mh.minze300
  ...
  /// Text/Icon auf der Button-Fläche (900).
  var buttonText: Color {
    switch self {
    case .links: Mh.minze900
  ...
  /// Zarte Fläche (100er) für Listen-Avatare.
  var avatarFlaeche: Color {
    switch self {
    case .links: Mh.minzeFlaeche
  ...
  /// Icon auf der zarten Fläche bzw. farbige Statistik-Zahl (700/300).
  var akzentText: Color {
    switch self {
    case .links: Mh.gruenText
